...
static const help_entry_t help_entries[] = {
    ...
    { "elf", "elf <info|load|run|run-linux|run-linux64> <file>", "ELF loader helper" },
    { "elf-debug", "elf-debug <file>", "Dump ELF metadata" },
    { "elf-crash", "elf-crash", "ELF crash test" },
    { "exec", "exec <file>", "Run ELF directly" },
    { "exec-linux", "exec-linux <file>", "Run ELF with Linux ABI (auto)" },
    { "exec-linux64", "exec-linux64 <file>", "Run ELF with Linux x86_64 ABI" },
